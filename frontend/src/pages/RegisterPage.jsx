...
const RegisterPage = () => {
    const { register, login, handleGoogleCredentialResponse } = useAuth();
            ...
            <div className="hidden lg:flex w-1/2 relative flex-col justify-between overflow-hidden bg-primary/10">
                ...
                <div className="relative z-10 p-12 max-w-2xl">
                    ...
                    <p className="text-lg text-white/90 font-medium max-w-md leading-relaxed">
                        Create an account to access exclusive features and manage your profile.
                    </p>
                </div>
            </div>
            ...
            <div className="flex w-full lg:w-1/2 flex-col items-center justify-center p-6 sm:p-12 relative bg-surface-light dark:bg-surface-dark">
                ...
                <div className="w-full max-w-[420px] flex flex-col">
                    <div className="mb-8">
                        ...
                        <p className="text-text-secondary dark:text-gray-400">Get started for free. No credit card required.</p>
                    </div>
                    ...
                    <div className="relative flex items-center py-4 mb-4">
                        ...
                        <span className="mx-4 shrink-0 text-xs font-medium uppercase text-text-secondary/80 tracking-wider">Or register with email</span>
                        <div className="grow border-t border-border-light dark:border-border-dark"></div>
                    </div>
                    ...
                    <p className="mt-8 text-center text-sm text-text-secondary dark:text-gray-400">
                        ...
                        <Link to="/login" className="font-semibold text-primary hover:text-primary-hover hover:underline transition-colors ml-1">Sign in</Link>
                    </p>
                </div>
            </div>
        </div>
